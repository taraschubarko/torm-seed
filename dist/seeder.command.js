...
let SeederCommand = class SeederCommand {
...
], SeederCommand.prototype, "create", null);
__decorate([
    nestjs_command_1.Command({
    ...
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)
], SeederCommand.prototype, "refresh", null);
__decorate([
    nestjs_command_1.Command({
    ...
    __metadata("design:returntype", Promise)
], SeederCommand.prototype, "makeSeederFile", null);
SeederCommand = __decorate([
    common_1.Injectable(),
